      ...
      <li class="step step-primary w-full">
        <div class="flex flex-col items-start">
          <div class="flex gap-5">
            ...
            <div>
              <span class="countdown font-mono text-2xl">
                <span :style="'--value: 9' + time1.h"></span>
              </span>
              hours
            </div>
            <div>
              <span class="countdown font-mono text-2xl">
                <span :style="'--value: 24' + time1.m"></span>
              </span>
              min
            </div>
            <div>
              <span class="countdown font-mono text-2xl">
                <span :style="'--value: ' + time1.s"></span>
              </span>
              sec
            </div>
          </div>
...
onMounted(() => {
  setInterval(() => {
    ...
    time1.value.h = DifferHourTime(timeNow, "2022-12-09 00:00:00");
    time1.value.m = DifferMinuteTime(timeNow, "2022-12-09 00:00:00");
    time1.value.s = DifferSecondTime(timeNow, "2022-12-09 00:00:00");
  }, 1000);
  console.log(time1.value.s);
});
