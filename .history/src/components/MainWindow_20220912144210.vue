          ...
          <div class="mb-5 rounded-full bg-base-200">
            <div class="flex p-1">
              <div
                ...
                :class="{ [`bg-base-100 shadow-lg`]:!theme}"
                @click="changeToLight"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div
                class="flex w-1/2 cursor-pointer justify-center gap-3 rounded-full px-5 py-1cla"
                                :class="{ [`bg-base-100 shadow-lg`]: theme == "light" }"
