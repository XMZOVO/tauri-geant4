  ...
  <div class="flex h-full flex-col overflow-hidden">
    ...
    <div class="h-1/2 flex-col">
      <div class="tabs px-10">
        <a
          :class="
            'tab tab-bordered' + (shownChartIndex == 0) ? ' tab-active' : ''
          "
          >能谱</a
        >
        <a
          class="'tab tab-bordered' + (shownChartIndex == 1) ? ' tab-active' : ''"
          >展宽谱</a
        >
        <a
          class="'tab tab-bordered' + (shownChartIndex == 2) ? ' tab-active' : ''"
          >刻度曲线</a
        >
      </div>

      <!--  -->
      <div class="flex h-5/6 items-center justify-center overflow-x-visible">
        <div
          v-show="shownChartIndex == 0"
          id="chart-container"
          class="h-full w-full"
        ></div>
