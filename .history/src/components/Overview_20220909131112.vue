...
<template>
  ...
  <!-- <p>{{ greetMsg }}</p> -->
  <!-- table1 -->
  <div class="h-1/2 overflow-x-auto overflow-y-visible px-10 py-6">
  ...
  <div class="h-1/2 flex-col">
    <div class="tabs px-10">
      ...
      <a class="tab tab-active tab-bordered">展宽谱</a>
      <a class="tab tab-bordered">刻度曲线</a>
    </div>

    <!--  -->
    <div
      class="flex h-full items-center justify-center overflow-x-visible p-10"
    >
