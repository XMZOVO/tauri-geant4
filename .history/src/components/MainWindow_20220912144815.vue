...
<template>
  <div
    :data-theme="selectedTheme == 1 ? 'dark' : 'light'"
    class="drawer-mobile drawer h-screen"
  >
          ...
          <div class="mb-5 rounded-full bg-base-200">
            <div class="flex p-1">
              <div
                ...
                :class="{ [`bg-base-100 shadow-lg`]: index == selectedTheme }"
                @click="changeTheme"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <!-- <div
                class="flex w-1/2 cursor-pointer justify-center gap-3 rounded-full py-1 px-5"
                :class="{ [`bg-base-100 shadow-lg`]: themeDark }"
                @click="changeTheme"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
