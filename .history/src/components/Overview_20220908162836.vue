...
<template>
  ...
  <div class="h-1/2 overflow-x-auto px-10 py-6">
    <div class="flex items-center gap-3 pb-5">
      ...
      <div class="dropdown">
        ...
        <div
          tabindex="0"
          class="card dropdown-content card-compact w-auto bg-base-100 p-2 shadow"
        >
          <div class="card-body">
            <div class="flex items-center">
              ...
              <div
                class="flex h-full w-full items-center justify-center overflow-x-visible"
              >
                <div id="chart-container2" class="h-full w-full"></div>
              </div>
            </div>
          </div>
        </div>
  ...
  <!--  -->
  <div class="flex h-1/2 items-center justify-center overflow-x-visible py-6">
