...
<template>
  ...
  <div class="h-1/2 overflow-x-auto px-10 py-6">
    <div class="flex items-center gap-3 pb-5">
      ...
      <div class="dropdown">
        ...
        <div
          tabindex="0"
          class="card dropdown-content card-compact w-screen bg-base-100 p-2 shadow"
        >
          <div class="card-body">
            <!-- 刻度选项 -->
  ...
  <!-- Chart -->
  <!-- xs -->
  <p class="px-10 text-lg font-bold">能谱图</p>

  <!--  -->
  <div class="flex h-1/2 items-center justify-center overflow-x-auto pb-6">
