          ...
          <div class="card-body gap-3">
            ...
            <div class="flex h-full flex-col justify-between">
              <div
                ...
                class="flex cursor-pointer items-center justify-between rounded-xl py-3 hover:bg-base-300"
              >
                <div class="flex items-center gap-2">
                  <img
                    :src="item.img"
                    class="h-12 w-12 rounded-xl bg-cyan-500"
                  />
