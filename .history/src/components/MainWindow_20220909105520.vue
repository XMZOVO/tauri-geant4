  ...
  <div :data-theme="theme" class="drawer-mobile drawer h-screen">
    ...
    <div class="drawer-side border-r border-solid border-base-300">
      ...
      >
        ...
        <div>
          <!-- App标题 -->
          <div class="hidden items-center justify-center gap-2 pb-10 lg:flex">
            <div class="hidden items-center px-4 font-bold md:text-3xl lg:flex">
              <img src="../assets/icon.png" class="h-10 w-10" />
              <div class="inline-flex md:text-3xl">
                <span class="text-cyan-500">Tauri</span>
                <span class="text-yellow-500">G4</span>
              </div>
            </div>
            <div class="font-bold text-base-content">V0.0.1</div>
          </div>
          <!-- App标题 -->
          <!-- 导航栏 -->
          <li>
            <a :class="{ active: isActive == 0 }" @click="homePageClick">
              ...
              <span class="flex-1">主页</span></a
            >
          </li>
          <li>
            <a :class="{ active: isActive == 1 }" @click="dashboardClick">
              <span class="flex-none">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              <span class="flex-1">概览</span>
            </a>
          </li>
          <li>
            <a :class="{ active: isActive == 3 }" @click="resultsClick">
              <span class="flex-none">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              <span class="flex-1">结果</span>
            </a>
          </li>
          <li>
            <a :class="{ active: isActive == 2 }" @click="settingClick">
              <span class="flex-none">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
