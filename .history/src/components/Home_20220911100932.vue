...
// import { openFile, draw } from "../../public/JsRoot720/modules/main.mjs";
...
onMounted(async () => {
  let a = document.getElementById("drawing");
  await JSROOT.openFile(
    "http://localhost:8080/file/G4Backend/build/rootFiles/wtest.root"
  );
  JSROOT.draw(a, "Default;1", "colz");
});
    ...
    <div class="w-2/3 space-y-12 border-r border-base-300 py-6 px-16">
      ...
      <div class="flex h-2/5 space-x-5">
        ...
        <div class="card w-1/2 bg-base-100 shadow-xl">
          <div class="card-body">
            <p class="text-sm font-semibold">相关参数</p>
            <!-- item -->
            <div
