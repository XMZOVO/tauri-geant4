...
let specFile = ref("");
let JSRootPath =
  "file:///Users/roy/Documents/GitHub/tauti-geant4/public/JsRoot720";

let detectorSrc = ref(
  JSRootPath +
    "/index.htm?nobrowser&file=http://localhost:8080/rootExample&item=Default;1&opt=ssao;BACK;transp60"
);
