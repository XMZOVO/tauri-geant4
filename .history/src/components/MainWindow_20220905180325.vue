      ...
      >
        ...
        <div class="flex flex-col">
          ...
          <div class="rounded-full bg-base-200">
            <div class="flex p-1">
              <div
                class="flex w-1/2 justify-center gap-3 rounded-full bg-base-100 px-5 py-1 shadow-lg"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              <div
                class="flex w-1/2 cursor-pointer justify-center gap-3 rounded-full px-5 py-1"
                @click="changeToDark"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
