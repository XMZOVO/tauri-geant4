...
const loadAsset = (asset: string) => {
  mtlLoader.load("src/assets/test111.mtl", (materials: any) => {
    materials.preload();

    materials.materials.forEach((element: any) => {
      element.transparent = true;
      element.opacity = 80;
    });
    // materials.materials.mtl1605.transparent = true;
    // materials.materials.mtl1605.opacity = 0.6;
