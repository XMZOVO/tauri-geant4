<template>
  <div class="flex h-screen bg-light-50">
    <!-- 导航栏 -->
    <div
      class="flex flex-col my-3 w-52 justify-between items-center border-r border-gray-200"
    >
      ...
      <div class="text-center">
        ...
        <div
          v-show="isLogin"
          class="flex items-center justify-between space-x-3 px-2 pt-3 border-t border-gray-200"
          :class="{
        ...
        >
          <div class="flex items-center gap-2">
            ...
            <div class="flex flex-col text-start">
              ...
              <div class="text-xs text-base-content font-sans opacity-60">
                Admin Account
              </div>
            </div>
          </div>
