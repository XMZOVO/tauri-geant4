import { Loader, LoaderUtils, FileLoader, Group, Vector3, BoxGeometry, Shape, Path, ExtrudeGeometry, SphereGeometry, ConeGeometry, TorusGeometry, BufferGeometry, MeshPhongMaterial, Mesh } from "three";
        ...
        function parseSolids() {
            ...
            for (var i = 0; i < solids.length; i++) {
                ...
                if (type === 'arb8') {
                    ...
                    const points = [
                        new Vector3(v5x, v5y, z),
                        new Vector3(v6x, v6y, z),
                        new Vector3(x2, y2, z),//0
