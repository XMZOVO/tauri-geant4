import { Loader, LoaderUtils, FileLoader, Group, Vector3, BoxGeometry, Shape, Path, ExtrudeGeometry,SphereGeometry, ConeGeometry,TorusGeometry } from "three";
        ...
        function parseSolids() {
            ...
            for (var i = 0; i < solids.length; i++) {
                ...
                if (type === 'trd') {
                    ...
                    var trd = new Geometry();

                    trd.vertices.push(new Vector3(x2, y2, z));
                    trd.vertices.push(new Vector3(-x2, y2, z));
                    trd.vertices.push(new Vector3(-x2, -y2, z));
                    trd.vertices.push(new Vector3(x2, -y2, z));

                    trd.vertices.push(new Vector3(x1, y1, -z));
                    trd.vertices.push(new Vector3(-x1, y1, -z));
                    trd.vertices.push(new Vector3(-x1, -y1, -z));
                    trd.vertices.push(new Vector3(x1, -y1, -z));
