        ...
        function parseSolids() {
            ...
            for (var i = 0; i < solids.length; i++) {
                ...
                if (type === 'box') {
                    ...
                    var x = solid.getAttribute('x') / 1e2;
                    var y = solid.getAttribute('y') / 1e2;
                    var z = solid.getAttribute('z') / 1e2;
                ...
                if (type === 'tube') {
                    ...
                    var rmin = solid.getAttribute('rmin') / 1e2;
                    var rmax = solid.getAttribute('rmax') / 1e2;
                    var z = solid.getAttribute('z') / 1e2;
            ...
            for (var i = 0; i < physvols.length; i++) {
                ...
                for (var j = 0; j < children.length; j++) {
                    ...
                    if (type === 'position') {
                        ...
                        position.set(x / 1e2, y / 1e2, z / 1e2);
                    }
